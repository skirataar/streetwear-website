  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
      ...
      <div className="flex items-center justify-between border-b-4 border-ink pb-4 mb-6">
        ...
        <Link
          href="/catalog"
          className="inline-flex items-center gap-1.5 text-xs font-mono font-bold uppercase text-ink hover:text-signal transition-colors"
        >
      ...
      {/* Cart Container Card */}
      <div className="bg-paper border-std p-6 sm:p-8">
